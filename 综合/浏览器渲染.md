...
- 从耗时的角度，浏览器请求、加载、渲染一个页面，时间花在下面[五件事情](https://link.zhihu.com/?target=https%3A//developers.google.com/speed/docs/insights/mobile)上：
...
其实这只能通过试验确定，已知的是，Chrome 中已经[不会阻塞渲染](https://link.zhihu.com/?target=https%3A//bugs.chromium.org/p/chromium/issues/detail%3Fid%3D571725)，Firefox、IE 在以前是阻塞的，现在会怎样我没有试验。
